...
(assert (= f0 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_199693 Bool) (BOUND_VARIABLE_199694 Bool)) (and BOUND_VARIABLE_199693 BOUND_VARIABLE_199694)) (nullable.lift (lambda ((BOUND_VARIABLE_199685 Int) (BOUND_VARIABLE_199686 Int)) (> BOUND_VARIABLE_199685 BOUND_VARIABLE_199686)) ((_ tuple.select 6) t) (nullable.some 1000)) (as nullable.null (Nullable Bool)))))))
(assert (= p1 (lambda ((t (Tuple (Nullable Bool)))) (and (nullable.is_some ((_ tuple.select 0) t)) (not (nullable.val ((_ tuple.select 0) t)))))))
(assert (= f2 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_199734 Bool) (BOUND_VARIABLE_199735 Bool)) (and BOUND_VARIABLE_199734 BOUND_VARIABLE_199735)) (nullable.lift (lambda ((BOUND_VARIABLE_199728 Int) (BOUND_VARIABLE_199729 Int)) (> BOUND_VARIABLE_199728 BOUND_VARIABLE_199729)) ((_ tuple.select 6) t) (nullable.some 1000)) (as nullable.null (Nullable Bool)))))))
...
(assert (= f3 (lambda ((t (Tuple (Nullable String)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_687801 String)) (str.to_upper BOUND_VARIABLE_687801)) (nullable.lift (lambda ((BOUND_VARIABLE_687794 String) (BOUND_VARIABLE_687795 String)) (str.++ BOUND_VARIABLE_687794 BOUND_VARIABLE_687795)) (nullable.lift (lambda ((BOUND_VARIABLE_687772 String) (BOUND_VARIABLE_687773 Int) (BOUND_VARIABLE_687774 Int)) (str.substr BOUND_VARIABLE_687772 BOUND_VARIABLE_687773 BOUND_VARIABLE_687774)) ((_ tuple.select 0) t) (nullable.some 0) (nullable.some (nullable.val (nullable.some 2)))) (nullable.lift (lambda ((BOUND_VARIABLE_687787 String) (BOUND_VARIABLE_687788 Int) (BOUND_VARIABLE_687789 Int)) (str.substr BOUND_VARIABLE_687787 BOUND_VARIABLE_687788 BOUND_VARIABLE_687789)) ((_ tuple.select 0) t) (nullable.some 2) (nullable.some (str.len (nullable.val ((_ tuple.select 0) t))))))) (nullable.lift (lambda ((BOUND_VARIABLE_687808 String) (BOUND_VARIABLE_687809 Int) (BOUND_VARIABLE_687810 Int)) (str.substr BOUND_VARIABLE_687808 BOUND_VARIABLE_687809 BOUND_VARIABLE_687810)) ((_ tuple.select 0) t) (nullable.some 0) (nullable.some (nullable.val (nullable.some 1))))))))
...
(assert (= f1 (lambda ((t (Tuple (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_1018626 Int) (BOUND_VARIABLE_1018627 Int)) (+ BOUND_VARIABLE_1018626 BOUND_VARIABLE_1018627)) ((_ tuple.select 0) t) ((_ tuple.select 1) t)) ((_ tuple.select 1) t) ((_ tuple.select 0) t)))))
(check-sat)
;answer: unsat
;-----------------------------------------------------------
...
(assert (= f1 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_1018762 Int) (BOUND_VARIABLE_1018763 Int)) (+ BOUND_VARIABLE_1018762 BOUND_VARIABLE_1018763)) ((_ tuple.select 0) t) ((_ tuple.select 7) t))))))
...
(assert (= f3 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_1018831 Int) (BOUND_VARIABLE_1018832 Int)) (+ BOUND_VARIABLE_1018831 BOUND_VARIABLE_1018832)) ((_ tuple.select 0) t) ((_ tuple.select 4) t))))))
(check-sat)
;answer: unknown (TIMEOUT)
;-----------------------------------------------------------
...
(declare-const p0 (-> (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)) Bool))
(declare-const p1 (-> (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)) Bool))
(assert (= p0 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (and (nullable.is_some ((_ tuple.select 6) t)) (nullable.is_some ((_ tuple.select 6) t)) (or (nullable.is_null (ite (nullable.val (nullable.lift (lambda ((BOUND_VARIABLE_1543229 Int) (BOUND_VARIABLE_1543230 Int)) (= BOUND_VARIABLE_1543229 BOUND_VARIABLE_1543230)) ((_ tuple.select 6) t) (nullable.some 1000))) (as nullable.null (Nullable Int)) (nullable.some 1))) (nullable.is_null (ite (nullable.val (nullable.lift (lambda ((BOUND_VARIABLE_1543243 Int) (BOUND_VARIABLE_1543244 Int)) (= BOUND_VARIABLE_1543243 BOUND_VARIABLE_1543244)) ((_ tuple.select 6) t) (nullable.some 2000))) (as nullable.null (Nullable Int)) (nullable.some 1))))))))
...
(assert (= p0 (lambda ((t (Tuple (Nullable Int) (Nullable Int)))) (and (nullable.is_some ((_ tuple.select 0) t)) (nullable.is_some ((_ tuple.select 1) t)) (> (+ (nullable.val ((_ tuple.select 0) t)) (nullable.val ((_ tuple.select 1) t))) 50)))))
(assert (= f1 (lambda ((t (Tuple (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_2054858 Int) (BOUND_VARIABLE_2054859 Int)) (+ BOUND_VARIABLE_2054858 BOUND_VARIABLE_2054859)) (nullable.lift (lambda ((BOUND_VARIABLE_2054852 Int) (BOUND_VARIABLE_2054853 Int)) (+ BOUND_VARIABLE_2054852 BOUND_VARIABLE_2054853)) ((_ tuple.select 0) t) ((_ tuple.select 1) t)) ((_ tuple.select 0) t))))))
(assert (not (= (bag.map f1 (bag.filter p0 (bag.union_disjoint (bag (tuple (nullable.some 10) (nullable.some 1)) 1) (bag (tuple (nullable.some 30) (nullable.some 3)) 1)))) (bag.map f2 (bag.difference_remove ((_ table.project 0 1) (bag (tuple (nullable.some 0) (nullable.some 0)) 1)) ((_ table.project 0 1) (bag (tuple (nullable.some 0) (nullable.some 0)) 1)))))))
(assert (= f2 (lambda ((t (Tuple (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_2054881 Int) (BOUND_VARIABLE_2054882 Int)) (+ BOUND_VARIABLE_2054881 BOUND_VARIABLE_2054882)) (nullable.lift (lambda ((BOUND_VARIABLE_2054875 Int) (BOUND_VARIABLE_2054876 Int)) (+ BOUND_VARIABLE_2054875 BOUND_VARIABLE_2054876)) ((_ tuple.select 0) t) ((_ tuple.select 1) t)) ((_ tuple.select 0) t))))))
(check-sat)
;answer: unsat
;-----------------------------------------------------------
...
(assert (= p0 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (and (nullable.is_some ((_ tuple.select 7) t)) (= (nullable.val ((_ tuple.select 7) t)) 10)))))
(assert (= f1 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple ((_ tuple.select 7) t) (nullable.lift (lambda ((BOUND_VARIABLE_2246954 Int) (BOUND_VARIABLE_2246955 Int)) (+ BOUND_VARIABLE_2246954 BOUND_VARIABLE_2246955)) ((_ tuple.select 7) t) (nullable.some 1)) (nullable.lift (lambda ((BOUND_VARIABLE_2246961 Int) (BOUND_VARIABLE_2246962 Int)) (+ BOUND_VARIABLE_2246961 BOUND_VARIABLE_2246962)) ((_ tuple.select 0) t) ((_ tuple.select 7) t))))))
(assert (= p2 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (and (nullable.is_some ((_ tuple.select 7) t)) (= (nullable.val ((_ tuple.select 7) t)) 10)))))
(assert (not (= (bag.map f1 (bag.filter p0 EMP)) (bag.map f3 (bag.filter p2 EMP)))))
(assert (= f3 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple (nullable.some 10) (nullable.some 11) (nullable.lift (lambda ((BOUND_VARIABLE_2246991 Int) (BOUND_VARIABLE_2246992 Int)) (+ BOUND_VARIABLE_2246991 BOUND_VARIABLE_2246992)) ((_ tuple.select 0) t) (nullable.some 10))))))
(check-sat)
;answer: unknown (TIMEOUT)
;-----------------------------------------------------------
...
(assert (= f1 (lambda ((t (Tuple (Nullable Int) (Nullable String)))) (tuple ((_ tuple.select 0) t) ((_ tuple.select 1) t) (nullable.lift (lambda ((BOUND_VARIABLE_2750178 Int) (BOUND_VARIABLE_2750179 Int)) (+ BOUND_VARIABLE_2750178 BOUND_VARIABLE_2750179)) ((_ tuple.select 0) t) (nullable.some 10))))))
(assert (= f2 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple ((_ tuple.select 0) t) ((_ tuple.select 1) t) ((_ tuple.select 2) t) ((_ tuple.select 3) t) ((_ tuple.select 4) t) ((_ tuple.select 6) t) ((_ tuple.select 5) t) ((_ tuple.select 7) t) ((_ tuple.select 8) t) (nullable.lift (lambda ((BOUND_VARIABLE_2750242 Int) (BOUND_VARIABLE_2750243 Int)) (* BOUND_VARIABLE_2750242 BOUND_VARIABLE_2750243)) ((_ tuple.select 7) t) (nullable.some 2))))))
...
(declare-const p0 (-> (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)) Bool))
(declare-const p1 (-> (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)) Bool))
(assert (= p0 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (and (nullable.is_some ((_ tuple.select 6) t)) (nullable.is_some ((_ tuple.select 6) t)) (nullable.is_some ((_ tuple.select 6) t)) (ite (= (nullable.val ((_ tuple.select 6) t)) 1000) (nullable.is_null (ite (nullable.val (nullable.lift (lambda ((BOUND_VARIABLE_3301153 Int) (BOUND_VARIABLE_3301154 Int)) (= BOUND_VARIABLE_3301153 BOUND_VARIABLE_3301154)) ((_ tuple.select 6) t) (nullable.some 1000))) (as nullable.null (Nullable Int)) (nullable.some 1))) (nullable.is_null (ite (nullable.val (nullable.lift (lambda ((BOUND_VARIABLE_3301164 Int) (BOUND_VARIABLE_3301165 Int)) (= BOUND_VARIABLE_3301164 BOUND_VARIABLE_3301165)) ((_ tuple.select 6) t) (nullable.some 2000))) (as nullable.null (Nullable Int)) (nullable.some 1))))))))
(assert (not (= ((_ table.project 6) (bag.filter p0 EMP)) ((_ table.project 6) (bag.filter p1 EMP)))))
