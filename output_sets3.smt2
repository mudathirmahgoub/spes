...
(assert (= f1 (lambda ((t (Tuple (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_162846 Int) (BOUND_VARIABLE_162847 Int)) (+ BOUND_VARIABLE_162846 BOUND_VARIABLE_162847)) ((_ tuple.select 0) t) ((_ tuple.select 1) t)) ((_ tuple.select 1) t) ((_ tuple.select 0) t)))))
(check-sat)
;answer: unsat
;-----------------------------------------------------------
...
(assert (= f1 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_162997 Int) (BOUND_VARIABLE_162998 Int)) (+ BOUND_VARIABLE_162997 BOUND_VARIABLE_162998)) ((_ tuple.select 0) t) ((_ tuple.select 7) t))))))
...
(assert (= f3 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_163066 Int) (BOUND_VARIABLE_163067 Int)) (+ BOUND_VARIABLE_163066 BOUND_VARIABLE_163067)) ((_ tuple.select 0) t) ((_ tuple.select 4) t))))))
(check-sat)
;answer: unknown (TIMEOUT)
;-----------------------------------------------------------
...
(declare-const p0 (-> (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)) Bool))
(declare-const p1 (-> (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)) Bool))
(assert (= p0 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (and (nullable.is_some ((_ tuple.select 6) t)) (nullable.is_some ((_ tuple.select 6) t)) (or (nullable.is_null (ite (nullable.val (nullable.lift (lambda ((BOUND_VARIABLE_318855 Int) (BOUND_VARIABLE_318856 Int)) (= BOUND_VARIABLE_318855 BOUND_VARIABLE_318856)) ((_ tuple.select 6) t) (nullable.some 1000))) (as nullable.null (Nullable Int)) (nullable.some 1))) (nullable.is_null (ite (nullable.val (nullable.lift (lambda ((BOUND_VARIABLE_318869 Int) (BOUND_VARIABLE_318870 Int)) (= BOUND_VARIABLE_318869 BOUND_VARIABLE_318870)) ((_ tuple.select 6) t) (nullable.some 2000))) (as nullable.null (Nullable Int)) (nullable.some 1))))))))
...
(assert (= p0 (lambda ((t (Tuple (Nullable Int) (Nullable Int)))) (and (nullable.is_some ((_ tuple.select 0) t)) (nullable.is_some ((_ tuple.select 1) t)) (> (+ (nullable.val ((_ tuple.select 0) t)) (nullable.val ((_ tuple.select 1) t))) 50)))))
(assert (= f1 (lambda ((t (Tuple (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_347109 Int) (BOUND_VARIABLE_347110 Int)) (+ BOUND_VARIABLE_347109 BOUND_VARIABLE_347110)) (nullable.lift (lambda ((BOUND_VARIABLE_347103 Int) (BOUND_VARIABLE_347104 Int)) (+ BOUND_VARIABLE_347103 BOUND_VARIABLE_347104)) ((_ tuple.select 0) t) ((_ tuple.select 1) t)) ((_ tuple.select 0) t))))))
(assert (not (= (set.map f1 (set.filter p0 (set.union (set.singleton (tuple (nullable.some 10) (nullable.some 1))) (set.singleton (tuple (nullable.some 30) (nullable.some 3)))))) (set.map f2 (set.minus ((_ rel.project 0 1) (set.singleton (tuple (nullable.some 0) (nullable.some 0)))) ((_ rel.project 0 1) (set.singleton (tuple (nullable.some 0) (nullable.some 0)))))))))
(assert (= f2 (lambda ((t (Tuple (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_347132 Int) (BOUND_VARIABLE_347133 Int)) (+ BOUND_VARIABLE_347132 BOUND_VARIABLE_347133)) (nullable.lift (lambda ((BOUND_VARIABLE_347126 Int) (BOUND_VARIABLE_347127 Int)) (+ BOUND_VARIABLE_347126 BOUND_VARIABLE_347127)) ((_ tuple.select 0) t) ((_ tuple.select 1) t)) ((_ tuple.select 0) t))))))
(check-sat)
;answer: unsat
;-----------------------------------------------------------
...
(assert (= p0 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (and (nullable.is_some ((_ tuple.select 7) t)) (= (nullable.val ((_ tuple.select 7) t)) 10)))))
(assert (= f1 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple ((_ tuple.select 7) t) (nullable.lift (lambda ((BOUND_VARIABLE_393302 Int) (BOUND_VARIABLE_393303 Int)) (+ BOUND_VARIABLE_393302 BOUND_VARIABLE_393303)) ((_ tuple.select 7) t) (nullable.some 1)) (nullable.lift (lambda ((BOUND_VARIABLE_393309 Int) (BOUND_VARIABLE_393310 Int)) (+ BOUND_VARIABLE_393309 BOUND_VARIABLE_393310)) ((_ tuple.select 0) t) ((_ tuple.select 7) t))))))
(assert (= p2 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (and (nullable.is_some ((_ tuple.select 7) t)) (= (nullable.val ((_ tuple.select 7) t)) 10)))))
(assert (not (= (set.map f1 (set.filter p0 EMP)) (set.map f3 (set.filter p2 EMP)))))
(assert (= f3 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple (nullable.some 10) (nullable.some 11) (nullable.lift (lambda ((BOUND_VARIABLE_393339 Int) (BOUND_VARIABLE_393340 Int)) (+ BOUND_VARIABLE_393339 BOUND_VARIABLE_393340)) ((_ tuple.select 0) t) (nullable.some 10))))))
(check-sat)
;answer: unknown (TIMEOUT)
;-----------------------------------------------------------
...
(assert (= f1 (lambda ((t (Tuple (Nullable Int) (Nullable String)))) (tuple ((_ tuple.select 0) t) ((_ tuple.select 1) t) (nullable.lift (lambda ((BOUND_VARIABLE_439922 Int) (BOUND_VARIABLE_439923 Int)) (+ BOUND_VARIABLE_439922 BOUND_VARIABLE_439923)) ((_ tuple.select 0) t) (nullable.some 10))))))
(assert (= f2 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple ((_ tuple.select 0) t) ((_ tuple.select 1) t) ((_ tuple.select 2) t) ((_ tuple.select 3) t) ((_ tuple.select 4) t) ((_ tuple.select 6) t) ((_ tuple.select 5) t) ((_ tuple.select 7) t) ((_ tuple.select 8) t) (nullable.lift (lambda ((BOUND_VARIABLE_439986 Int) (BOUND_VARIABLE_439987 Int)) (* BOUND_VARIABLE_439986 BOUND_VARIABLE_439987)) ((_ tuple.select 7) t) (nullable.some 2))))))
...
(declare-const p0 (-> (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)) Bool))
(declare-const p1 (-> (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)) Bool))
(assert (= p0 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (and (nullable.is_some ((_ tuple.select 6) t)) (nullable.is_some ((_ tuple.select 6) t)) (nullable.is_some ((_ tuple.select 6) t)) (ite (= (nullable.val ((_ tuple.select 6) t)) 1000) (nullable.is_null (ite (nullable.val (nullable.lift (lambda ((BOUND_VARIABLE_523951 Int) (BOUND_VARIABLE_523952 Int)) (= BOUND_VARIABLE_523951 BOUND_VARIABLE_523952)) ((_ tuple.select 6) t) (nullable.some 1000))) (as nullable.null (Nullable Int)) (nullable.some 1))) (nullable.is_null (ite (nullable.val (nullable.lift (lambda ((BOUND_VARIABLE_523962 Int) (BOUND_VARIABLE_523963 Int)) (= BOUND_VARIABLE_523962 BOUND_VARIABLE_523963)) ((_ tuple.select 6) t) (nullable.some 2000))) (as nullable.null (Nullable Int)) (nullable.some 1))))))))
(assert (not (= ((_ rel.project 6) (set.filter p0 EMP)) ((_ rel.project 6) (set.filter p1 EMP)))))
