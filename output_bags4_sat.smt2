...
(assert (not (= q1 q2)))
(assert (= f1 (lambda ((t (Tuple (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_268660 Int) (BOUND_VARIABLE_268661 Int)) (+ BOUND_VARIABLE_268660 BOUND_VARIABLE_268661)) ((_ tuple.select 0) t) ((_ tuple.select 1) t)) ((_ tuple.select 1) t) ((_ tuple.select 0) t)))))
...
(assert (= f1 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_268819 Int) (BOUND_VARIABLE_268820 Int)) (+ BOUND_VARIABLE_268819 BOUND_VARIABLE_268820)) ((_ tuple.select 0) t) ((_ tuple.select 7) t))))))
...
(assert (not (= q1 q2)))
(assert (= f3 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_268889 Int) (BOUND_VARIABLE_268890 Int)) (+ BOUND_VARIABLE_268889 BOUND_VARIABLE_268890)) ((_ tuple.select 0) t) ((_ tuple.select 4) t))))))
...
(declare-const p1 (-> (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)) Bool))
(declare-const q2 (Bag (Tuple (Nullable Int))))
(assert (= p0 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (and (nullable.is_some ((_ tuple.select 6) t)) (nullable.is_some ((_ tuple.select 6) t)) (or (nullable.is_null (ite (nullable.val (nullable.lift (lambda ((BOUND_VARIABLE_375220 Int) (BOUND_VARIABLE_375221 Int)) (= BOUND_VARIABLE_375220 BOUND_VARIABLE_375221)) ((_ tuple.select 6) t) (nullable.some 1000))) (as nullable.null (Nullable Int)) (nullable.some 1))) (nullable.is_null (ite (nullable.val (nullable.lift (lambda ((BOUND_VARIABLE_375234 Int) (BOUND_VARIABLE_375235 Int)) (= BOUND_VARIABLE_375234 BOUND_VARIABLE_375235)) ((_ tuple.select 6) t) (nullable.some 2000))) (as nullable.null (Nullable Int)) (nullable.some 1))))))))
(assert (not (= q1 q2)))
...
(assert (= f1 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple ((_ tuple.select 0) t) ((_ tuple.select 1) t) ((_ tuple.select 2) t) ((_ tuple.select 3) t) ((_ tuple.select 4) t) ((_ tuple.select 6) t) ((_ tuple.select 5) t) ((_ tuple.select 7) t) ((_ tuple.select 8) t) (nullable.lift (lambda ((BOUND_VARIABLE_397310 Int) (BOUND_VARIABLE_397311 Int)) (+ BOUND_VARIABLE_397310 BOUND_VARIABLE_397311)) ((_ tuple.select 7) t) (nullable.lift (lambda ((BOUND_VARIABLE_397304 Int) (BOUND_VARIABLE_397305 Int)) (- BOUND_VARIABLE_397304 BOUND_VARIABLE_397305)) (nullable.some 5) (nullable.some 5)))))))
...
(assert (= p3 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (and (nullable.is_some ((_ tuple.select 0) t)) (nullable.is_some ((_ tuple.select 0) t)) (nullable.is_some ((_ tuple.select 0) t)) (nullable.is_some (nullable.lift (lambda ((BOUND_VARIABLE_397415 Bool) (BOUND_VARIABLE_397416 Bool) (BOUND_VARIABLE_397417 Bool)) (and BOUND_VARIABLE_397415 BOUND_VARIABLE_397416 BOUND_VARIABLE_397417)) (nullable.some (= (nullable.val ((_ tuple.select 0) t)) (+ 7 8))) (nullable.some (= (nullable.val ((_ tuple.select 0) t)) (+ 8 7))) (nullable.lift (lambda ((BOUND_VARIABLE_397407 Int) (BOUND_VARIABLE_397408 Int)) (= BOUND_VARIABLE_397407 BOUND_VARIABLE_397408)) (nullable.some (nullable.val ((_ tuple.select 0) t))) (ite (nullable.is_some (nullable.some 2)) (nullable.some 15) (as nullable.null (Nullable Int)))))) (nullable.val (nullable.lift (lambda ((BOUND_VARIABLE_397415 Bool) (BOUND_VARIABLE_397416 Bool) (BOUND_VARIABLE_397417 Bool)) (and BOUND_VARIABLE_397415 BOUND_VARIABLE_397416 BOUND_VARIABLE_397417)) (nullable.some (= (nullable.val ((_ tuple.select 0) t)) (+ 7 8))) (nullable.some (= (nullable.val ((_ tuple.select 0) t)) (+ 8 7))) (nullable.lift (lambda ((BOUND_VARIABLE_397407 Int) (BOUND_VARIABLE_397408 Int)) (= BOUND_VARIABLE_397407 BOUND_VARIABLE_397408)) (nullable.some (nullable.val ((_ tuple.select 0) t))) (ite (nullable.is_some (nullable.some 2)) (nullable.some 15) (as nullable.null (Nullable Int))))))))))
(assert (not (= q1 q2)))
(assert (= f4 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_397458 Int) (BOUND_VARIABLE_397459 Int)) (+ BOUND_VARIABLE_397458 BOUND_VARIABLE_397459)) (nullable.some 1) (nullable.some 2)) (nullable.lift (lambda ((BOUND_VARIABLE_397473 Int) (BOUND_VARIABLE_397474 Int)) (+ BOUND_VARIABLE_397473 BOUND_VARIABLE_397474)) ((_ tuple.select 0) t) (nullable.lift (lambda ((BOUND_VARIABLE_397467 Int) (BOUND_VARIABLE_397468 Int)) (+ BOUND_VARIABLE_397467 BOUND_VARIABLE_397468)) (nullable.some 3) (nullable.some 3))) (nullable.lift (lambda ((BOUND_VARIABLE_397485 Int) (BOUND_VARIABLE_397486 Int)) (+ BOUND_VARIABLE_397485 BOUND_VARIABLE_397486)) (nullable.lift (lambda ((BOUND_VARIABLE_397479 Int) (BOUND_VARIABLE_397480 Int)) (+ BOUND_VARIABLE_397479 BOUND_VARIABLE_397480)) (nullable.some 5) (nullable.some 6)) ((_ tuple.select 0) t)) (as nullable.null (Nullable Int)) (nullable.some 2) (nullable.lift (lambda ((BOUND_VARIABLE_397491 Int) (BOUND_VARIABLE_397492 Int)) (+ BOUND_VARIABLE_397491 BOUND_VARIABLE_397492)) (nullable.some 7) (nullable.some 8))))))
...
(assert (= f1 (lambda ((t (Tuple (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_431870 Int) (BOUND_VARIABLE_431871 Int)) (+ BOUND_VARIABLE_431870 BOUND_VARIABLE_431871)) (nullable.lift (lambda ((BOUND_VARIABLE_431864 Int) (BOUND_VARIABLE_431865 Int)) (+ BOUND_VARIABLE_431864 BOUND_VARIABLE_431865)) ((_ tuple.select 0) t) ((_ tuple.select 1) t)) ((_ tuple.select 0) t))))))
(assert (= p2 (lambda ((t (Tuple (Nullable Int) (Nullable Int)))) false)))
(assert (not (= q1 q2)))
(assert (= f3 (lambda ((t (Tuple (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_431903 Int) (BOUND_VARIABLE_431904 Int)) (+ BOUND_VARIABLE_431903 BOUND_VARIABLE_431904)) (nullable.lift (lambda ((BOUND_VARIABLE_431897 Int) (BOUND_VARIABLE_431898 Int)) (+ BOUND_VARIABLE_431897 BOUND_VARIABLE_431898)) ((_ tuple.select 0) t) ((_ tuple.select 1) t)) ((_ tuple.select 0) t))))))
(assert (= q1 (bag.map f1 (bag.filter p0 (bag.union_disjoint (bag (tuple (nullable.some 10) (nullable.some 1)) 1) (bag (tuple (nullable.some 30) (nullable.some 3)) 1))))))
...
(assert (= p0 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (and (nullable.is_some ((_ tuple.select 7) t)) (= (nullable.val ((_ tuple.select 7) t)) 10)))))
(assert (= f1 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple ((_ tuple.select 7) t) (nullable.lift (lambda ((BOUND_VARIABLE_483088 Int) (BOUND_VARIABLE_483089 Int)) (+ BOUND_VARIABLE_483088 BOUND_VARIABLE_483089)) ((_ tuple.select 7) t) (nullable.some 1)) (nullable.lift (lambda ((BOUND_VARIABLE_483095 Int) (BOUND_VARIABLE_483096 Int)) (+ BOUND_VARIABLE_483095 BOUND_VARIABLE_483096)) ((_ tuple.select 0) t) ((_ tuple.select 7) t))))))
(assert (= p2 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (and (nullable.is_some ((_ tuple.select 7) t)) (= (nullable.val ((_ tuple.select 7) t)) 10)))))
(assert (not (= q1 q2)))
(assert (= f3 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple (nullable.some 11) (nullable.some 11) (nullable.lift (lambda ((BOUND_VARIABLE_483125 Int) (BOUND_VARIABLE_483126 Int)) (+ BOUND_VARIABLE_483125 BOUND_VARIABLE_483126)) ((_ tuple.select 0) t) (nullable.some 10))))))
(assert (= q1 (bag.map f1 (bag.filter p0 EMP))))
...
(assert (= f1 (lambda ((t (Tuple (Nullable Int) (Nullable String)))) (tuple ((_ tuple.select 0) t) ((_ tuple.select 1) t) (nullable.lift (lambda ((BOUND_VARIABLE_540380 Int) (BOUND_VARIABLE_540381 Int)) (+ BOUND_VARIABLE_540380 BOUND_VARIABLE_540381)) ((_ tuple.select 0) t) (nullable.some 10))))))
(assert (= f2 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple ((_ tuple.select 0) t) ((_ tuple.select 1) t) ((_ tuple.select 2) t) ((_ tuple.select 3) t) ((_ tuple.select 4) t) ((_ tuple.select 6) t) ((_ tuple.select 5) t) ((_ tuple.select 7) t) ((_ tuple.select 8) t) (nullable.lift (lambda ((BOUND_VARIABLE_540404 Int) (BOUND_VARIABLE_540405 Int)) (* BOUND_VARIABLE_540404 BOUND_VARIABLE_540405)) ((_ tuple.select 7) t) (nullable.some 2))))))
(assert (not (= q1 q2)))
(assert (= p3 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable Int) (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (and (nullable.is_some ((_ tuple.select 2) t)) (nullable.is_some ((_ tuple.select 12) t)) (= (nullable.val ((_ tuple.select 2) t)) (nullable.val ((_ tuple.select 12) t)))))))
...
(declare-const q2 (Bag (Tuple (Nullable Int) (Nullable Int))))
(assert (not (= q1 q2)))
(assert (= p0 (lambda ((t (Tuple (Nullable Int) (Nullable Int)))) (and (nullable.is_some (nullable.lift (lambda ((BOUND_VARIABLE_781388 Int) (BOUND_VARIABLE_781389 Int)) (> BOUND_VARIABLE_781388 BOUND_VARIABLE_781389)) (nullable.some (+ 1 2)) (nullable.lift (lambda ((BOUND_VARIABLE_781381 Int) (BOUND_VARIABLE_781382 Int)) (+ BOUND_VARIABLE_781381 BOUND_VARIABLE_781382)) (nullable.some 3) (as nullable.null (Nullable Int))))) (nullable.val (nullable.lift (lambda ((BOUND_VARIABLE_781388 Int) (BOUND_VARIABLE_781389 Int)) (> BOUND_VARIABLE_781388 BOUND_VARIABLE_781389)) (nullable.some (+ 1 2)) (nullable.lift (lambda ((BOUND_VARIABLE_781381 Int) (BOUND_VARIABLE_781382 Int)) (+ BOUND_VARIABLE_781381 BOUND_VARIABLE_781382)) (nullable.some 3) (as nullable.null (Nullable Int)))))))))
...
(declare-const p1 (-> (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)) Bool))
(declare-const q2 (Bag (Tuple (Nullable Int))))
(assert (= p0 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (and (nullable.is_some ((_ tuple.select 6) t)) (nullable.is_some ((_ tuple.select 6) t)) (nullable.is_some ((_ tuple.select 6) t)) (ite (= (nullable.val ((_ tuple.select 6) t)) 1000) (nullable.is_null (ite (nullable.val (nullable.lift (lambda ((BOUND_VARIABLE_793434 Int) (BOUND_VARIABLE_793435 Int)) (= BOUND_VARIABLE_793434 BOUND_VARIABLE_793435)) ((_ tuple.select 6) t) (nullable.some 1000))) (as nullable.null (Nullable Int)) (nullable.some 1))) (nullable.is_null (ite (nullable.val (nullable.lift (lambda ((BOUND_VARIABLE_793445 Int) (BOUND_VARIABLE_793446 Int)) (= BOUND_VARIABLE_793445 BOUND_VARIABLE_793446)) ((_ tuple.select 6) t) (nullable.some 2000))) (as nullable.null (Nullable Int)) (nullable.some 1))))))))
(assert (not (= q1 q2)))
