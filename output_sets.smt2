...
(assert (= f0 (lambda ((t (Tuple (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_3261 Int) (BOUND_VARIABLE_3262 Int)) (+ BOUND_VARIABLE_3261 BOUND_VARIABLE_3262)) ((_ tuple.select 0) t) ((_ tuple.select 1) t))))))
(check-sat)
;answer: unsat
;-----------------------------------------------------------
...
(assert (= f3 (lambda ((t (Tuple (Nullable String)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_68695 String)) (str.to_upper BOUND_VARIABLE_68695)) (nullable.lift (lambda ((BOUND_VARIABLE_68688 String) (BOUND_VARIABLE_68689 String)) (str.++ BOUND_VARIABLE_68688 BOUND_VARIABLE_68689)) (nullable.lift (lambda ((BOUND_VARIABLE_68666 String) (BOUND_VARIABLE_68667 Int) (BOUND_VARIABLE_68668 Int)) (str.substr BOUND_VARIABLE_68666 BOUND_VARIABLE_68667 BOUND_VARIABLE_68668)) ((_ tuple.select 0) t) (nullable.some 0) (nullable.some (nullable.val (nullable.some 2)))) (nullable.lift (lambda ((BOUND_VARIABLE_68681 String) (BOUND_VARIABLE_68682 Int) (BOUND_VARIABLE_68683 Int)) (str.substr BOUND_VARIABLE_68681 BOUND_VARIABLE_68682 BOUND_VARIABLE_68683)) ((_ tuple.select 0) t) (nullable.some 2) (nullable.some (str.len (nullable.val ((_ tuple.select 0) t))))))) (nullable.lift (lambda ((BOUND_VARIABLE_68702 String) (BOUND_VARIABLE_68703 Int) (BOUND_VARIABLE_68704 Int)) (str.substr BOUND_VARIABLE_68702 BOUND_VARIABLE_68703 BOUND_VARIABLE_68704)) ((_ tuple.select 0) t) (nullable.some 0) (nullable.some (nullable.val (nullable.some 1))))))))
...
(assert (= f1 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_197804 Int) (BOUND_VARIABLE_197805 Int)) (+ BOUND_VARIABLE_197804 BOUND_VARIABLE_197805)) ((_ tuple.select 0) t) ((_ tuple.select 7) t))))))
...
(assert (= f3 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple (nullable.lift (lambda ((BOUND_VARIABLE_197874 Int) (BOUND_VARIABLE_197875 Int)) (+ BOUND_VARIABLE_197874 BOUND_VARIABLE_197875)) ((_ tuple.select 0) t) ((_ tuple.select 4) t))))))
(check-sat)
;answer: unknown (TIMEOUT)
;-----------------------------------------------------------
...
(assert (= p0 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (and (nullable.is_some ((_ tuple.select 7) t)) (= (nullable.val ((_ tuple.select 7) t)) 10)))))
(assert (= f1 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple ((_ tuple.select 7) t) (nullable.lift (lambda ((BOUND_VARIABLE_442124 Int) (BOUND_VARIABLE_442125 Int)) (+ BOUND_VARIABLE_442124 BOUND_VARIABLE_442125)) ((_ tuple.select 7) t) (nullable.some 1)) (nullable.lift (lambda ((BOUND_VARIABLE_442131 Int) (BOUND_VARIABLE_442132 Int)) (+ BOUND_VARIABLE_442131 BOUND_VARIABLE_442132)) ((_ tuple.select 0) t) ((_ tuple.select 7) t))))))
(assert (= p2 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (and (nullable.is_some ((_ tuple.select 7) t)) (= (nullable.val ((_ tuple.select 7) t)) 10)))))
(assert (not (= (set.map f1 (set.filter p0 EMP)) (set.map f3 (set.filter p2 EMP)))))
(assert (= f3 (lambda ((t (Tuple (Nullable Int) (Nullable String) (Nullable String) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int) (Nullable Int)))) (tuple (nullable.some 10) (nullable.some 11) (nullable.lift (lambda ((BOUND_VARIABLE_442162 Int) (BOUND_VARIABLE_442163 Int)) (+ BOUND_VARIABLE_442162 BOUND_VARIABLE_442163)) ((_ tuple.select 0) t) (nullable.some 10))))))
(check-sat)
;answer: unknown (TIMEOUT)
;-----------------------------------------------------------
